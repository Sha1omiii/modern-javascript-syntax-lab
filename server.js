...
// const pizzaToppings = ['Pineapple', 'Olives', 'Anchovies']; // already defined on line 12
...
// Your code here
function def (noun = 'cat', adjective = 'white') {
...
// Your code here
pizza = pizza ? console.log('yum') : console.log('yuck');

const localLandConfig = null;
// 1. SET LANGUAGE
...
// Your code here
const LANG = localLandConfig || 'English'
// Log the result
